...
import { DsOpenSubMenuTestComponent } from './open-sub-menu-test.component';
...
describe('DsOpenSubMenuDirective', () => {
  let fixture: ComponentFixture<DsOpenSubMenuTestComponent>;
  let component: DsOpenSubMenuTestComponent;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [DsOpenSubMenuTestComponent, DsOpenMenuComponent, DsOpenSubMenuDirective],
      providers: [Renderer2],
    });

    fixture = TestBed.createComponent(DsOpenSubMenuTestComponent);
  ...
  it('should create submenu component on click', () => {
    const debugElement = fixture.debugElement.query(By.directive(DsOpenSubMenuDirective));
    const directive = debugElement.injector.get(DsOpenSubMenuDirective);
  ...
  it('should dismiss submenu if already open on click', () => {
    ...
    const element = fixture.debugElement.query(By.directive(DsOpenSubMenuDirective));
  ...
  it('should set inputs to SprOpenMenuComponent', () => {
    ...
    const queryList = new QueryList<DsOpenMenuItemDirective>();
    ...
    expect(mockSetInput).toHaveBeenCalledWith('items', queryList.toArray());
  ...
  it('should add classes after view init', () => {
    ...
    expect(addClassSpy).toHaveBeenCalledWith(expect.anything(), 'open-menu-component__item-holder');
  });

  describe('customPlacement logic', () => {
    let directive: DsOpenSubMenuDirective;
    let debugElement: DebugElement;
    let hostElement: HTMLElement;

    beforeEach(() => {
      debugElement = fixture.debugElement.query(By.directive(DsOpenSubMenuDirective));
      directive = debugElement.injector.get(DsOpenSubMenuDirective);
