...
import { SprTableDataService } from './spr-table-data.service';

describe('SprTableDataService', () => {
  let service: SprTableDataService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(SprTableDataService);
