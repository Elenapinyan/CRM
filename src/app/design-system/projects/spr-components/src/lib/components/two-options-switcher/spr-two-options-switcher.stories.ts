...
const meta: Meta<SprTwoOptionsSwitcherComponent> = {
  title: 'shared components/TwoOptionsSwitcher',
  component: SprTwoOptionsSwitcherComponent,
  decorators: [
    moduleMetadata({
...
export const TwoOptionsSwitcher: StoryObj<SprTwoOptionsSwitcherComponent & { formControl: FormControl }> = {
  args: {
    isDisabled: false,
