...
import { SprTwoOptionsSwitcherComponent } from './spr-two-options-switcher.component';

describe('SprTwoOptionsSwitcher', () => {
  const MOCK_START_VALUE = '1';
  const MOCK_END_VALUE = '2';

  let component: SprTwoOptionsSwitcherComponent;
  let fixture: ComponentFixture<SprTwoOptionsSwitcherComponent>;
  let cvaOnChangeSpy: jest.SpyInstance;

  beforeEach(() => {
    TestBed.configureTestingModule({});

    fixture = TestBed.createComponent(SprTwoOptionsSwitcherComponent);
  ...
  describe('View', () => {
    it('should disable', () => {
      ...
      const divElement: HTMLElement = getElementByCss(fixture, '.two-options-switcher-control').nativeElement;
    ...
    it('should add name and id to input', () => {
      ...
      const inputElement: HTMLElement = getElementByCss(fixture, '.form-two-options-switcher').nativeElement;
