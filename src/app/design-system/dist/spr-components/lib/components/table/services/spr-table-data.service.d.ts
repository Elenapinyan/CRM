...
export declare class SprTableDataService<Column extends DisplayedColumn = DisplayedColumn, Row extends {
    [key: string]: any;
} = {
    [key: string]: any;
}> {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<SprTableDataService<any, any>, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<SprTableDataService<any, any>>;
}
