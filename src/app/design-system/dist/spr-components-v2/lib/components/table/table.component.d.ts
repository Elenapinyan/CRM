...
import { PaginationParams } from '../pagination-bar';
...
export declare class DsTableComponent<Column extends DisplayedColumn, Row extends {
    [key: string]: any;
}> implements OnInit {
    ...
    readonly headerTemplates: QueryList<DsTableHeaderDirective<Column>>;
    readonly rowTemplates: QueryList<DsTableRowDirective<Row>>;
    readonly exportFormats: typeof ExportFormats;
    readonly sort: typeof SortType;
    constructor(tableDataService: DsTableDataService<Column, Row>, destroyRef: DestroyRef, cdRef: ChangeDetectorRef);
