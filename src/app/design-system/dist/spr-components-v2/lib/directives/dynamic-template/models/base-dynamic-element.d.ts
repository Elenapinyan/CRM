...
import { AbstractDynamicElement, DynamicElementModel, DynamicPosition, DynamicProjection } from '../interfaces';
export declare class BaseDynamicElement<T extends HTMLElement = HTMLElement> extends AbstractDynamicElement<T> implements DynamicElementModel<T> {
    ...
    private elementResolvedProjection?;
    ...
    updateProjection(projection: DynamicProjection, container?: HTMLElement | null | undefined): void;
